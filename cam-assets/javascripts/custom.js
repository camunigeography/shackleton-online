...
projectlight.markExternalLinks = function(){
  if (jQuery.browser.msie) {
    $("#content a[href*='shackletononline']").not(".campl-carousel a[href*='http://']").addClass("campl-external").attr({
      "title": $(this).attr("title")+" (Link to an external website)"
    })  
  }else{
    $('#content a').not(".campl-carousel a").filter(function(){
      return this.hostname && !this.hostname.match(/(cam.ac.uk|spriprints.com|shackletononline.hammer.dev|shackletononline.powderdev.com|shackletononline)/gi);
